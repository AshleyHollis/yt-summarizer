 ...
 * GET /api/auth/me
 *
 * DIAGNOSTIC: Auth0 code temporarily disabled to isolate SWA warmup timeout issue.
 * Returns 503 to indicate authentication is disabled for testing.
 */
export async function GET() {
  return NextResponse.json({ error: 'Auth disabled for SWA diagnostic testing' }, { status: 503 });
}

// DIAGNOSTIC: Original Auth0 implementation commented out
