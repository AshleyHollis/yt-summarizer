...
export const copilotBoxStyles = {
  ...
  static:
    'bg-[var(--copilot-kit-secondary-color)] rounded-xl p-4 border border-[var(--copilot-kit-separator-color)]',
} as const;
...
export const copilotButtonStyles = {
  ...
  iconAccent:
    'p-1.5 rounded-md hover:bg-[var(--copilot-kit-secondary-color)] text-[var(--copilot-kit-primary-color)] transition-colors',
  /** Interactive item with hover */
  interactive:
    'hover:bg-[var(--copilot-kit-secondary-color)]/60 hover:border-[var(--copilot-kit-primary-color)]/50 transition-all duration-150 cursor-pointer',
} as const;
...
export const copilotThreadStyles = {
  ...
  container:
    'border-b border-[var(--copilot-kit-separator-color)] bg-[var(--copilot-kit-secondary-color)]',
  ...
  toggle:
    'group flex items-center gap-2 flex-1 min-w-0 border border-transparent hover:border-[var(--copilot-kit-primary-color)] hover:bg-[var(--copilot-kit-background-color)] rounded-lg px-2 py-1.5 -mx-2 transition-all duration-150',
  /** Toggle button for collapse/expand */
  toggleButton:
    'group flex items-center gap-2 flex-1 min-w-0 border border-transparent hover:border-[var(--copilot-kit-primary-color)] hover:bg-[var(--copilot-kit-background-color)] rounded-lg px-3 py-2 transition-all duration-150 text-[13px] text-[var(--copilot-kit-secondary-contrast-color)]',
  /** Thread title text */
  title:
    'text-[13px] text-[var(--copilot-kit-secondary-contrast-color)] overflow-hidden text-ellipsis whitespace-nowrap',
  /** Thread title when active */
  titleActive:
    'text-[13px] text-[var(--copilot-kit-primary-color)] font-medium overflow-hidden text-ellipsis whitespace-nowrap',
  ...
  emptyState:
    'flex flex-col items-center justify-center py-6 text-[var(--copilot-kit-muted-color)] text-[13px] gap-2',
  ...
  /** Thread item in list */
  threadItem:
    'flex items-center gap-2 px-3 py-2 cursor-pointer transition-all duration-150 group mx-1 my-0.5 rounded-lg border border-transparent hover:border-[var(--copilot-kit-primary-color)] hover:bg-[var(--copilot-kit-background-color)]',
  /** Active thread item in list */
  threadItemActive:
    'bg-[var(--copilot-kit-primary-color)]/10 border-[var(--copilot-kit-primary-color)]',
  ...
  /** Active thread item */
  itemActive:
    'bg-[var(--copilot-kit-primary-color)]/10 border-l-2 border-[var(--copilot-kit-primary-color)] rounded-l-none',
  ...
  newButton:
    'p-1.5 rounded-lg border border-transparent hover:border-[var(--copilot-kit-primary-color)] hover:bg-[var(--copilot-kit-background-color)] text-[var(--copilot-kit-primary-color)] flex-shrink-0 transition-all duration-150',
  /** Delete button for thread items */
  deleteButton:
    'opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-[var(--copilot-kit-primary-color)]/20 text-[var(--copilot-kit-muted-color)] hover:text-[var(--copilot-kit-primary-color)] transition-all duration-150',
...
export const copilotImplicitMessageStyles = {
  ...
  container:
    'bg-[var(--copilot-kit-secondary-color)] rounded-xl p-4 border border-[var(--copilot-kit-separator-color)] hover:border-[var(--copilot-kit-primary-color)] transition-all duration-150 mb-4',
  /** Message text */
