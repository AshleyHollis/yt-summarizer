...
TEMPLATE_FILE="${TEMPLATE_FILE:-${REPO_ROOT}/scripts/ci/templates/prod-kustomization-template.yaml}"
OUTPUT_FILE="${OUTPUT_FILE:-${REPO_ROOT}/k8s/overlays/prod/kustomization.yaml}"
...
envsubst '${IMAGE_TAG}' < "$TEMPLATE_FILE" >> "$OUTPUT_FILE"
