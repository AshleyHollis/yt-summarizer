...
- Python 3.11 (API), YAML (Kubernetes manifests), TypeScript (GitHub Actions) + cert-manager, NGINX Gateway Fabric, ExternalDNS, Kustomize, ArgoCD (003-preview-dns-cloudflare)
- Azure SQL (existing), Cloudflare DNS API (003-preview-dns-cloudflare)
...
## Recent Changes
- 003-preview-dns-cloudflare: Added Python 3.11 (API), YAML (Kubernetes manifests), TypeScript (GitHub Actions) + cert-manager, NGINX Gateway Fabric, ExternalDNS, Kustomize, ArgoCD
