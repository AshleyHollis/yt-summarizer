...
import {
  ...
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/openai-api-key/c8f65984fa984088a5424015734c42e2"
}

import {
  to = azurerm_key_vault_secret.secrets["azure-openai-api-key"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/azure-openai-api-key/1f5731d215474c89b8ebda98dcabc621"
}

import {
  to = azurerm_key_vault_secret.secrets["azure-openai-endpoint"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/azure-openai-endpoint/89b3a333679d4005afa3b28987fb131a"
}

import {
  to = azurerm_key_vault_secret.secrets["azure-openai-deployment"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/azure-openai-deployment/dc03f43bce2645a9b223e080da3034cd"
}

import {
  to = azurerm_key_vault_secret.secrets["azure-openai-embedding-deployment"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/azure-openai-embedding-deployment/08d7880e8913466ebecf5ad7557784ed"
}

import {
  to = azurerm_key_vault_secret.secrets["cloudflare-api-token"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/cloudflare-api-token/2c36824f08b340979717d0e236ab1c4a"
}

import {
  to = azurerm_key_vault_secret.secrets["webshare-proxy-username"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/webshare-proxy-username/dc30133af7fd4c48a2d666e2be4529c5"
}

import {
  to = azurerm_key_vault_secret.secrets["webshare-proxy-password"]
  id = "https://kv-ytsumm-prd-ci.vault.azure.net/secrets/webshare-proxy-password/7d1e39d0742d40fdad974c39fe11c7da"
}
