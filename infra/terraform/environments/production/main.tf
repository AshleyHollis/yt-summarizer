...
# =============================================================================
# Deploys Azure infrastructure for the production environment
...
# Note: In production, we typically share ACR with staging to avoid duplication
# -----------------------------------------------------------------------------
...
module "sql" {
  ...
  # Serverless for cost savings, but with longer pause delay
  sku_name                    = "GP_S_Gen5_1"
  auto_pause_delay_in_minutes = 120 # 2 hours for production
...
module "aks" {
  ...
  # Single-node for cost savings (hobby project)
  node_count   = 1
