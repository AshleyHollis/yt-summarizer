...
class TestLivePipelineExecution:
    ...
    def test_full_video_processing_pipeline(self, live_client, headers, sample_youtube_url):
        ...
        assert video_data.get("transcript_url") is not None, (
            "Completed video should have transcript_url"
        )
...
class TestPipelineRegressions:
    ...
    def test_video_response_model_has_content_urls(self):
        ...
        assert "transcript_url" in field_names, "VideoResponse missing transcript_url field"
        assert "summary_url" in field_names, "VideoResponse missing summary_url field"
